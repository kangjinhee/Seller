...
public class PermissionDialog {
   ...
   /* @Inject
    ...
    public PermissionDialog(SplashActivity context) {
        ...
        alert_confirm.setMessage("네트워크 연결상태를 확인해 주세요.").setCancelable(false)
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        context.startActivityForResult(new Intent(Settings.ACTION_DATA_ROAMING_SETTINGS), SplashActivity.REQUEST_CHECK_NETWORK);
